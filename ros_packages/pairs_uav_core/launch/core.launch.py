...
def generate_launch_description():
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_managers'), '/launch/control_manager.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_managers'), '/launch/safety_area_manager.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_managers'), '/launch/uav_manager.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_managers'), '/launch/transform_manager.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_managers'), '/launch/constraint_manager.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_managers'), '/launch/gain_manager.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_managers'), '/launch/estimation_manager.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_trajectory_generation'), '/launch/trajectory_generation.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('pairs_uav_status'), '/launch/acquisition.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
                'custom_config': custom_config,
